  ...
  return (
    <div className="pb-2">
      <div className="flex flex-col my-1 md:flex-row md:items-end md:justify-between gap-2">
        ...
        <p className="flex flex-row gap-1 justify-start text-xs font-serif font-medium rounded-md p-1 bg-slate-300"><CompanyIcon size={16}/> <h1 className="truncate">{company}</h1></p>
      </div>
      
      <div className="flex items-start flex-row gap-4 text-xs text-gray-700">
